...
> **Note:** Debugging from external memory is currently not supported.
...
- To debug application in:
  ...
  - **DEVELOPMENT MODE:**
    > **Note:** Breakpoint limits require setting the first breakpoint at FSBL BOOT_Application instead of main.
